        ...
        object Z1_VOLUP_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( STATUS < 0 ))  ) ) 
                    ...
                    Trace( "Error connecting socket to address {0} on port  {1:d}", CLIENTIPADDRESS , (short)CLIENTPORTNUMBER) ; 
                    }
                
                __context__.SourceCodeLine = 25;
                Trace( "Soc status {0:d}\r\n", (short)RUSSSOUNDSOCKET.SocketStatus) ; 
                __context__.SourceCodeLine = 27;
                STATUS = (short) ( Functions.SocketSend( RUSSSOUNDSOCKET , "EVENT C[1].Z[1]!KeyPress VolumeUp\r" ) ) ; 
                __context__.SourceCodeLine = 28;
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( STATUS < 0 ))  ) ) 
                    {
                    __context__.SourceCodeLine = 29;
                    Trace( "Error sending: {0:d}", (short)STATUS) ; 
                    }
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( STATUS < 0 ))  ) ) 
                    ...
                    Trace( "Error disconnecting socket to address {0} on port  {1:d}", CLIENTIPADDRESS , (short)CLIENTPORTNUMBER) ; 
                    }
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        CLIENTIPADDRESS  .UpdateValue ( "10.0.0.145"  ) ; 
